...
@component('components.breadcrumb')
    @slot('li_1')  ร่วมนำเสนอผลงานวิชาการ @endslot
    @slot('title') ร่วมนำเสนอผลงานวิชาการ @endslot
@endcomponent
<div class="row">
  <div class="col">
    <div class="h-100">
        ...
        <div class="col-6">
          <div class="card">
            <div class="card-header align-items-center d-flex">
              <h4 class="card-title mb-0 flex-grow-1">จำนวนเงินสนับสนุนตามปี</h4>
            </div>
