...
@component('components.breadcrumb')
    @slot('li_1')  Citation ระดับนานาชาติ @endslot
    @slot('title') Citation ระดับนานาชาติ @endslot
@endcomponent
<div class="row">
  <div class="col">
    <div class="h-100">
  ...
  <script>
    $( document ).ready(function() {
      ...
      let tb = $('#tb').DataTable({
        ...
        ajax: {
          url: "citation/list/international",
          type: "POST",
          data: function (d) {
            d.year = $("#year").val()
      ...
      function getChart(chartType){
        ...
        $.ajax({
          url: "/citation/chart/international",
          method: "POST",
          data: {
            year: $("#year").val(),
